...
const Home = () => {
  ...
  return (
    <div className='home'>
      <div className="hero">
        <h1>Crypto Marketplace- <br /> CryptoPort</h1>
        <p>Welcome to the cryptocurrenct marketplace </p>
        <form onSubmit={searchHandler}>
            <input type="text" placeholder='Search Crypto...' onChange={inputHandler} required value={input}/>
